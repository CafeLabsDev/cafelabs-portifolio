...
// mind-landing (CafeLabsDev/mind-landing). Atualizado em 2026-07-17 (2ª
// versão do Felipe, com o novo acento de círculo dentro do "D").
export function MindLogo({ className }: MindLogoProps) {
  return (
    <svg viewBox="0 0 2770 1724" className={className} role="img" aria-label="mind">
      <path fill="currentColor" d="M250 350V1724H0V350H250Z" />
      <path fill="currentColor" d="M1321 350V1724H1071V350H1321Z" />
      <path fill="currentColor" d="M2082 350V1724H1832V350H2082Z" />
